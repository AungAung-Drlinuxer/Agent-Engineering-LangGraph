...
### ဘာကြောင့် လဲ
Tools အများအပြား ပေးထားရင် LLM က မလိုအပ်တဲ့ tool ကို ရွေးတာ၊ permission ကျယ်တဲ့ tool ကို 误 သုံးတာတွေ ဖြစ်နိုင်ပါတယ်။ အန္တရာယ်ရှိတဲ့ လုပ်ဆောင်ချက် (delete၊ payment) တွေကို agent လက်ထဲ မပေးရင် မလုပ်နိုင်တော့ပါဘူး။
